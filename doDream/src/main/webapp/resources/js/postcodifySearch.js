...
(function($) {
    ...
    $.fn.postcodifyPopUp = function(options) {
        ...
        return this.each(function() {
            ...
            // 추가한 설정 블라라라라
            var insertPostcode5 = options.insertPostcode5;
            var insertAddress = options.insertAddress;
            var insertDetails = options.insertDetails;
            ...
            initializePostcodify = function() {
                ...
                layer.find("div.postcodify_results").postcodify($.extend({
                    ...
                    insertPostcode5 : container.find(insertPostcode5),
                    insertPostcode : container.find(".postcodify_postcode"),
                    insertAddress : container.find(insertAddress),
                    insertDetails : container.find(insertDetails),
