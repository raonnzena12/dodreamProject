		...
		<div class="row">
			...
			<div class="col-md-4">
				<div id="pfImgOuter">
					...
					<c:if test="${ !empty loginUser.userProfileImage }">
					<img alt="프로필사진" src="${contextPath}/resources/images/userProfileImage/${loginUser.userProfileImage}" class="rounded-circle" id="userProfileImage" name="userProfileImage"/>
					</c:if>					
