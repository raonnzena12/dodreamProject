												...
												<tbody>
													<c:forEach var="p" items="${ list }" varStatus="status">
														<tr role="row" class="odd">
															...
															<td>
																<a href="detailSt.dr?pNo=${p.pNo}"  target="_blank" style="text-decoration:none; color: gray;">${ p.pTitle }</a>
															</td>
															<td>${ p.pGoal}</td>
															<td>${ p.pStartDate}</td>
															<td>${ p.pCloseDate }</td>
															...
															<td>
																<button type="button" data-toggle="modal" data-target="#exampleModal${ status.index }" data-whatever="프로젝트 내리기"
 																 id="stopProjectBtn" class="btn btn-primary btn-lg btn-block rewardBtn">프로젝트 내리기</button>
 																 <!-- Modal -->
 																<form action ="stopProjectBtn.dr" method="post">
																  ...
																  <div class="modal-dialog" role="document">
																    <div class="modal-content">
																      <div class="modal-header">
																        <h5 class="modal-title" id="exampleModalLabel">프로젝트 내리기</h5>
