											...
											<table class="table table-bordered dataTable" id="dataTable"
												...
												<thead>
													<tr role="row">
														...
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
															aria-label="Age: activate to sort column ascending">카테고리 이름</th>
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
															aria-label="Start date: activate to sort column ascending">댓글 내용</th>
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
															aria-label="Salary: activate to sort column ascending">프로젝트 번호</th>
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
															aria-label="Salary: activate to sort column ascending">댓글 작성일</th>
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
															aria-label="Salary: activate to sort column ascending">댓글 처리</th>
													</tr>
												</thead>
												<tfoot>
													<tr>
														<th rowspan="1" colspan="1">댓글 번호</th>
														<th rowspan="1" colspan="1">작성자 이름</th>
														<th rowspan="1" colspan="1">카테고리 이름</th>
														<th rowspan="1" colspan="1">댓글 내용</th>
														<th rowspan="1" colspan="1">프로젝트 번호</th>
														<th rowspan="1" colspan="1">댓글 작성일</th>
														<th rowspan="1" colspan="1">댓글 처리</th>
													</tr>
												</tfoot>
												<tbody>
													<c:forEach var="r" items="${ list }"  varStatus="status" >
														<tr role="row" class="odd">
															<td class="sorting_1">${ r.reNo }</td>
															<td>${ r.reWriter}</td>
															<td>${ r.reCGName}</td>
															<td>${ r.reContent}</td>
															<td>${ r.reRefPNo}</td>
															<td>${ r.reWriDate}</td>
															<td>
																<button type="button" data-toggle="modal" data-target="#exampleModal${ status.index }" data-whatever="삭제하기"
 																 id="removeReply" class="btn btn-primary btn-lg btn-block rewardBtn">삭제하기</button>
 																 <!-- Modal -->
 																<form action ="removeReply.dr" method="post">
