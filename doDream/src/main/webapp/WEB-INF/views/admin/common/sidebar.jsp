	...
	<!-- Sidebar -->
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-controls="dropDown1"> <i class="fas fa-fw fa-cog"></i> <span>회원 관리
						</span>
			</a>
				<div id="dropDown1" class="collapse" aria-labelledby="headingTwo"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="adminMlist.dr"><p>〉  일반회원 관리</p></a> <a
							class="collapse-item" href="adminBlist.dr"><p>〉  블랙리스트 관리</p></a>
					</div>
				</div></li>

			<li class="nav-item"><a class="nav-link collapsed" href="#"
				data-toggle="collapse" data-target="#dropDown2" aria-expanded="true"
				aria-controls="dropDown2"> <i class="fas fa-fw fa-cog"></i> <span>프로젝트 관리
						</span>
			</a>
				<div id="dropDown2" class="collapse" aria-labelledby="headingTwo"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="adminFlist1.dr"><p>〉  심사중</p></a> <a
							class="collapse-item" href="adminFlist2.dr"><p>〉  오픈중</p></a> <a
							class="collapse-item" href="adminFlist3.dr"><p>〉  마감된</p></a>
					</div>
				</div></li>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="dropDown3" class="collapse" aria-labelledby="headingTwo"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="adminPlist1.dr"><p>〉  주문 예약 현황</p></a>
						<a class="collapse-item" href="adminPlist2.dr"><p>〉  결제 완료 현황</p></a>
						<a class="collapse-item" href="adminPlist3.dr"><p>〉  취소 및 환불 현황</p></a>
					</div>
				</div></li>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-controls="dropDown5"> <i class="fas fa-fw fa-cog"></i> <span>게시판 관리</span>
			</a>
				<div id="dropDown5" class="collapse" aria-labelledby="headingTwo"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="#"><p>〉  공지사항</p></a>
						<a class="collapse-item" href="#"><p>〉  프로젝트 후기</p></a>
						<a class="collapse-item" href="#"><p>〉  댓글 관리</p></a>
					</div>
				</div></li>
