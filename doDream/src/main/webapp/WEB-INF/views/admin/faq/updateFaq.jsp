...
<body id="page-top">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<form action="updateFaq.dr" name="updateFaqForm" id="updateFaqForm" method="post">
				 							...
				 							<div class="col-sm-12">
					 							<table align="center" id="tb" cellpadding="15" cellspacing="0" width="1000px" >
													<tr>
														<!-- summnote 에디터 출력 -->
														<th>FAQ 제목 : </th>
														<td><input type="text" name="fTitle" size="97" placeholder="제목을 입력해주세요." value="${faq.fTitle }"></th>
													</tr>
													<tr>
														<th style="padding-bottom: 55%;">FAQ 내용 : </th>
														<td><textarea id="summernote" name="fContent">${faq.fContent }</textarea><td>
													</tr> 
													<!-- 등록된 이미지 목록 -->
	...
	<script>
		...
		function cancle(){
			$("#updateFaqForm").attr("action","cancleFaq.dr");
		}
