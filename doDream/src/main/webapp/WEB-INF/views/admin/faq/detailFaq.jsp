				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<c:url var="goUpdateFaq" value="goUpdateFaq.dr">
								<c:param name="fNo" value="${ faq.fNo }"/>
							</c:url>
							<c:url var="removeFaq" value="removeFaq.dr">
								<c:param name="fNo" value="${ faq.fNo }"/>
							</c:url>
							<c:url var="adminFaqList" value="adminFaqList.dr">
							</c:url>
							<span class="float-right">
								<button type="button" class="btn btn-primary btn-lg btn-inline rewardBtn" style="background: #8E44AD; border: #8E44AD;"
								onclick="location.href='${goUpdateFaq}'">수정하기</button>
								<button type="button" class="btn btn-primary btn-lg btn-inline rewardBtn" style="background: #8E44AD; border: #8E44AD;"
								onclick="location.href='${removeFaq}'">삭제하기</button> 	
								<button type="button" class="btn btn-primary btn-lg btn-inline rewardBtn" style="background: #8E44AD; border: #8E44AD;"
								onclick="location.href='${adminFaqList}'">목록으로</button> 
							</span>
						</div>
						<div class="card-body">  
			 							...
			 							<div class="col-sm-12">
			 								<table align="center" id="tb" cellpadding="10" cellspacing="0" width="1000px">
												<tr align="center" valign="middle">
													<th colspan="2" id="tb-header">${ faq.fNo }번 글 상세보기</th>
												</tr>
												<tr>
												...
												<tr>
													<th class="th">작성자</th>
													<td>${ faq.userNickname }</td>
												</tr>		
												<tr>
													<th class="th">작성일</th>
													<td>${ faq.fEnrollDate}</td>
												</tr>		
												<tr height="300">
													<th class="th">내용</th>
													<td>${ faq.fContent }</td>
