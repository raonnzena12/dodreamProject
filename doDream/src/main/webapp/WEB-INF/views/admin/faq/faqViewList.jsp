				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							...
							onclick="location.href='goWriteFaq.dr'">FAQ 작성</button>
						</div>
						<div class="card-body">
											...
											<table class="table table-bordered dataTable" id="dataTable"
												...
												<thead>
													<tr role="row">
														...
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
															aria-label="Salary: activate to sort column ascending">FAQ 수정</th>
													</tr>
												</thead>
												<tfoot>
													<tr>
														<th rowspan="1" colspan="1">FAQ 번호</th>
														<th rowspan="1" colspan="1">FAQ 제목</th>
														<th rowspan="1" colspan="1">작성일</th>
														<th rowspan="1" colspan="1">수정일</th>
														<th rowspan="1" colspan="1">작성자</th>
														<th rowspan="1" colspan="1">FAQ 수정</th>
													</tr>
												</tfoot>
												<tbody>
