...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<br>
					<!-- DataTales Example -->
					<form action="insertFaq.dr" name="insertFaqForm" id="insertFaqForm" method="post">
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<span class="float-right">
									<button class="btn btn-primary btn-lg btn-inline rewardBtn" type="button" id="submitBtn" style="background: #8E44AD; border: #8E44AD;">FAQ 등록</button>
									...
									<div id="dataTable_wrapper"
										...
										<div class="row">
											...
											<table align="center" id="tb" cellpadding="15" cellspacing="0" width="780px" >
												<tr>
													<!-- summnote 에디터 출력 -->
													<th> FAQ 제목 : <input type="text" name="fTitle" size="80" placeholder="제목을 입력해주세요."></th>
												</tr>
												<tr>
	...
	<script>
		...
		function cancle(){
			$("#insertFaqForm").attr("action","cancleFaq.dr");
		}
