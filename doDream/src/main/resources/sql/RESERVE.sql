...
SELECT R.RESERVE_NO, R.RESERVE_DATE, R.RESERVE_USER, R.RESERVE_REF_PNO, R.RESERVE_STATUS_NO, R.PROJECT_TITLE, R.FUND_DATE, P.PROJECT_AT_NM, P.PROJECT_CT_NAME, P.D_DAY
