...
/// 공동사용
	 ...
	 * @return result;
	 */
	public abstract int insertProject(Project project, MultipartFile uploadfile1, MultipartFile uploadfile2,
			MultipartFile uploadfile3, HttpServletRequest request);

	/**
	 * 리워드 번호 스트링으로 해당하는 리워드 리스트를 반환하는 Service (스트링 복수개일 경우 '/'(슬래쉬)로 구분하여 보낼 것)
	 * 
	 * @param rewardStr
	 * @return rList
	 */
	...
	/**
	 * 리스트에서 좋아요 누르는 Service status 1 : 좋아요 / status 0 : 좋아요 취소
	 * 
	 * @param like
	 * @param status
	 * @return result
	...
	/**
	 * 메인 출력에 필요한 리스트들 (인기순, 최신등록순, 마감임박순) 받아오는 Service
	 * 
	 * @param userNo
	 * @return allList
	 */
